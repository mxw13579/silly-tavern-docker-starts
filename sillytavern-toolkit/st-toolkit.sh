...
while true; do
    ...
    # 直接调用并显示状态
    bash ./scripts/sources.sh status
    bash ./scripts/docker.sh status
    bash ./scripts/sillytavern.sh status
    echo "----------------------------------------------------------"
    echo
    echo "--- 主菜单 ---"
    ...
    case $main_choice in
        1)
            ...
            while true; do
                ...
                case $sources_choice in
                    1) bash ./scripts/sources.sh set aliyun ;;
                    2) bash ./scripts/sources.sh set tencent ;;
                    3) bash ./scripts/sources.sh set huawei ;;
                    4) bash ./scripts/sources.sh restore ;;
                    0) break ;;
                    *) msg_error "无效选项" ;;
                esac
        ...
        2)
            ...
            while true; do
                ...
                case $docker_choice in
                    1) bash ./scripts/docker.sh install ;;
                    2) bash ./scripts/docker.sh config_mirror ;;
                    3) bash ./scripts/docker.sh restart_service ;;
                    4) bash ./scripts/docker.sh list_images ;;
                    0) break ;;
                    *) msg_error "无效选项" ;;
                esac
        ...
        3)
            ...
            while true; do
                ...
                case $st_choice in
                    1) bash ./scripts/sillytavern.sh install ;;
                    2) bash ./scripts/sillytavern.sh start ;;
                    3) bash ./scripts/sillytavern.sh stop ;;
                    4) bash ./scripts/sillytavern.sh restart ;;
                    5) bash ./scripts/sillytavern.sh update ;;
                    6) bash ./scripts/sillytavern.sh logs ;;
                    7) bash ./scripts/sillytavern.sh backup ;;
                    8) bash ./scripts/sillytavern.sh change_password ;;
                    0) break ;;
                    *) msg_error "无效选项" ;;
                esac
